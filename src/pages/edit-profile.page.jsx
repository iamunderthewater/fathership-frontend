...
const EditProfile = () => {
    ...
    let { personal_info: { fullname, username: profile_username, profile_img, email, bio, birthdate, gender }, social_links } = profile;
        ...
        if(access_token){
            ...
            .catch(err => {
                ...
                if(err.response.status == 403){
                    // logout user with toaster notification
                    toast.error("An error occured while processing your request. Please log in again.")
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                                <div>
                                    <InputBox name="birthdate" type="date" value={birthdate} disable={true} icon="fi-rr-calendar-day" />
                                </div>
                                <div>
                                    <InputBox name="text" type="text" value={gender} disable={true} icon="fi-rr-user" />
                                </div>
                            </div>
