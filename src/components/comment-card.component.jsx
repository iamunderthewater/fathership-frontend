...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    return (
        <div className="w-full" style={{ paddingLeft: `${leftVal * 10}px` }}>
            <div className="my-5 p-6 pb-1 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-center mt-5">

                    {
                        ...
                        <button className="text-dark-grey p-2 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2 whitespace-nowrap" onClick={loadReplies}>
                ...
                <div className="pl-3 flex justify-end mt-4">
                    <ReportComponent type={"comment"} _id={_id} />
                </div>
