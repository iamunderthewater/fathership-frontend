...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let { seen, type, reply, createdAt, comment, replied_on_comment, user, user: { personal_info: { fullname, username, profile_img } }, blog: { _id , blog_id, title } = {}, _id: notification_id, community } = data;
    ...
    const handleDelete = (comment_id, type, target) => {
        ...
        .then(() => {
            ...
            setNotifications({ ...notifications, results, totalDocs: totalDocs - 1, deletedDocCount: (notifications.deletedDocCount ? notifications.deletedDocCount : 0) + 1 })
            ...
            <div className="flex gap-5 mb-3">
                ...
                <div className="w-full">
...

                    {
                        ...
                        type == "kick" ?
                        <p>From the community - {community.name}</p>
                        :
                        type == "reply" ?
