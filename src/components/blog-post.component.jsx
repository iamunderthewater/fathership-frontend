...
const BlogPostCard = ({ content, author }) => {
    ...
    let { publishedAt, title, des, banner, activity: { total_likes }, category: { name: category }, blog_id: id } = content;
    let { fullname, profile_img, username } = author;

    return ( 
        <Link to={`/article/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
