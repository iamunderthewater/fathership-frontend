...
import Alerts from "./alertWindow.component";
...
const Navbar = () => {
    ...
    const { userAuth, userAuth: { access_token, profile_img, new_notification_available, alerts }, setUserAuth } = useContext(UserContext);
